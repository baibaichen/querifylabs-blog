...
public class TPCH {
    ...
    public static final String MODEL_01 =
            "     {\n" +
            "       \"type\": \"custom\",\n" +
            "       \"name\": \"" + NAME_01 + "\",\n" +
    ...
    private static final String _01 =
            ...
            + "  l_returnflag,\n"
            + "  l_linestatus";
    private static final String _02 =
              "select\n"
            + "  s.s_acctbal,\n"
            + "  s.s_name,\n"
            + "  n.n_name,\n"
            ...
            + "  p.p_partkey\n"
            + "limit 100";
    private static final String _03 =
              "select\n"
            + "  l.l_orderkey,\n"
            ...
            + "  o.o_orderdate\n"
            + "limit 10";
    private static final String _04 =
              "select\n"
            + "  o_orderpriority,\n"
            ...
            + "order by\n"
            + "  o_orderpriority";
    private static final String _05 =
              "select\n"
            + "  n.n_name,\n"
            + "  sum(l.l_extendedprice * (1 - l.l_discount)) as revenue\n"
            + "\n"
            ...
            + "order by\n"
            + "  revenue desc";
    private static final String _06 =
              "select\n"
    ...
    private static final String _07 =
              "select\n"
            + "  supp_nation,\n"
            + "  cust_nation,\n"
            + "  l_year,\n"
            ...
            + "  cust_nation,\n"
            + "  l_year";
    private static final String _08 =
              "select\n"
            + "  o_year,\n"
            + "  sum(case\n"
            ...
            + "order by\n"
            + "  o_year";
    private static final String _09 =
              "select\n"
            + "  nation,\n"
            + "  o_year,\n"
            ...
            + "  nation,\n"
            + "  o_year desc";
    private static final String _10 =
              "select\n"
            + "  c.c_custkey,\n"
            + "  c.c_name,\n"
            + "  sum(l.l_extendedprice * (1 - l.l_discount)) as revenue,\n"
            ...
            + "  revenue desc\n"
            + "limit 20";
    private static final String _11 =
              "select\n"
            + "  ps.ps_partkey,\n"
            ...
            + "order by\n"
            + "  \"value\" desc";
    private static final String _12 =
              "select\n"
            + "  l.l_shipmode,\n"
            + "  sum(case\n"
            ...
            + "order by\n"
            + "  l.l_shipmode";
    private static final String _13 =
              "select\n"
            + "  c_count,\n"
            + "  count(*) as custdist\n"
            + "from\n"
            ...
            + "  custdist desc,\n"
            + "  c_count desc";
    private static final String _14 =
              "select\n"
            + "  100.00 * sum(case\n"
    ...
    private static final String _15 =
            ...
            + "order by\n"
            + "  s.s_suppkey";
    private static final String _16 =
              "select\n"
            + "  p.p_brand,\n"
            + "  p.p_type,\n"
            + "  p.p_size,\n"
            ...
            + "  p.p_type,\n"
            + "  p.p_size";
    private static final String _17 =
              "select\n"
            ...
            + "  )";
    private static final String _18 =
              "select\n"
            + "  c.c_name,\n"
            + "  c.c_custkey,\n"
            + "  o.o_orderkey,\n"
            ...
            + "  o.o_orderdate\n"
            + "limit 100";
    private static final String _19 =
              "select\n"
            + "  sum(l.l_extendedprice* (1 - l.l_discount)) as revenue\n"
            + "from\n"
            + "  tpch.lineitem l,\n"
            ...
            + "    and l.l_shipinstruct = 'DELIVER IN PERSON'\n"
            + "  )";
    private static final String _20 =
              "select\n"
            + "  s.s_name,\n"
            + "  s.s_address\n"
            + "from\n"
            ...
            + "order by\n"
            + "  s.s_name";
    private static final String _21 =
              "select\n"
            + "  s.s_name,\n"
            + "  count(*) as numwait\n"
            + "from\n"
            ...
            + "  s.s_name\n"
            + "limit 100";
    private static final String _22 =
              "select\n"
            + "  cntrycode,\n"
            + "  count(*) as numcust,\n"
    ...
    private static final List<String> SQL22 =
        ImmutableList.of(_01, _02, _03, _04, _05, _06, _07 , _08, _09, _10, _11, _12, _13, _14, _15, _16, _17, _18, _19, _20, _21, _22);
    static final double SCALE_FACTOR = 0.01d;
    public static final Schema SCHEMA = new TpchSchema(SCALE_FACTOR, 1, 1, false);
    public static String sql(int i) {
        Preconditions.checkArgument(i>0 && i <= SQL22.size());
        return SQL22.get(i-1);
    }
