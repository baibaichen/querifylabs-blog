...
class OptimizerTest {
    @Test
    void test_tpch_q6() throws Exception {
        ...
        Optimizer optimizer = Optimizer.create(schema.getSchemaName(), schema);
        ...
        RelNode optimizerRelTree =
                optimizer.optimize(relTree, relTree.getTraitSet().plus(EnumerableConvention.INSTANCE), true);
